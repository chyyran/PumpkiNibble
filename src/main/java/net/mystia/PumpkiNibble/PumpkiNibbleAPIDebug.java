 ...
 * 
 */
public class PumpkiNibbleAPIDebug {
	...
	public Integer getPotionDuration(String type, String effect) {
		Integer potionDuration = plugin.getConfig().getInt(
				"items.pumpkin.potionDuration.regen");
	...
	public Integer getPotionStrength(String type, String effect) {
		Integer potionStrength = plugin.getConfig().getInt(
				"items.pumpkin.potionStrength.regen");
	...
	public String getEatMessage(String type) {
		String eatMessage = plugin.getConfig()
				.getString("items.pumpkin.messageOnEat");
		return eatMessage;
	}
	...
	public String getInsufficientMessage(String type) {
		String insufficientMessage = plugin.getConfig().getString(
				"items.pumpkin.messageInsufficient");
	...
	public Integer getHealFoodAmount(String type) {
		Integer healFood = plugin.getConfig().getInt("items.pumpkin.healFoodAmount");
		if (healFood == null) {
			healFood = 0;
		}
		return healFood;
	...
	public Integer getHealHealthAmount(String type) {
		Integer healHealth = plugin.getConfig().getInt(
				"items.pumpkin.healHealthAmount");
		if (healHealth == null) {
			healHealth = 0;
		}
		return healHealth;
	...
	public Integer getItemAmount(String type) {
		Integer itemAmount = plugin.getConfig().getInt("items.pumpkin.itemAmount");
		if (itemAmount == null) {
			itemAmount = 1;
		}
		return itemAmount;
	...
	public boolean isEnabled(String type) {
		boolean ifEnabled = plugin.getConfig().getBoolean("items.pumpkin.enabled");
		return ifEnabled;
	}
	/**
	...
	public String getUnableMessage(String type){
		String unableMessage = plugin.getConfig().getString("items.pumpkin.messageUnable");
	...
	public Set<String> getValidItems(){
		...
		for (String item : allItems){
			if(!plugin.getConfig().getBoolean("items.pumpkin.enabled")){
				validItems.add(item);
				}
